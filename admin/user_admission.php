...
<br>
<br>
<center>    <h4 style="color:green; font-style:normal; font-family: monospace; font-size: 25px;" >ADMINISTRATOR FOR ADMISSIONS</h4></center>
<br>
<br>
<br>
<div class="container">
  <!--Modal for add admissions administrator-->
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addnewuser" id="add"><i class="fa fa-plus-circle" aria-hidden="true"></i>
   Add New User
  </button>
  <!--End of Modal-->
</div>
...
<div class="container-fluid">
  ...
  <table  class="table-bordered table-hover" id="user_data" >
      <thead>
      <tr>
    <td>USER ID</td>
    <td>NAME</td>
    ...
    <td>ACTIONS</td>
      ...
      $sql = $conn->query('SELECT * FROM user1 ORDER BY UserID');
             while ($data = $sql->fetch_array())  
      {
        ...
        <tr>
         ...
         <td>************************</td>        
        <td>
  <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#view_<?php echo $data['UserID']; ?>"><i class="fa fa-eye"></i> View</button>

  <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_<?php echo $data["UserID"]; ?>"><i class="fa fa-edit"></i> Edit</button>

<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#del_<?php echo $data['UserID']; ?>"><i class="fa fa-trash"></i> Delete</button>
...
<?php include('adduser1_modal.php'); ?>
 </div>
 <br>
<br>
<br>
