...
<br>
<br>
<center>    <h4 style="color:green; font-style:normal; font-family: monospace; font-size: 25px;" >ADMINISTRATOR FOR EXEATS</h4></center>
...
<div class="container-fluid">
  ...
  <table  class="table-bordered table-hover" id="exeat_data" >
    ...
    <td>ACTIONS</td>
      ...
      $sql = $conn->query('SELECT * FROM user ORDER BY UserID');
...
<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#del_<?php echo $data['UserID']; ?>"><i class="fa fa-trash"></i> Delete</button>
  <?php include("user1_button.php"); ?>
  
  </td>
  </tr>

       <?php
    include("view1_modal.php"); 
      }
