        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                   <img src="img/img/download.jpg">&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="modal-title" id="myModalLabel" style="font-size: 20px;">  Delete Exeat User details</span>
            ...
            <!--Modal Body-->
                ...
                <div class="container-fluid">
                    <?php
                        $a=mysqli_query($conn,"select * from user where UserID='".$data['UserID']."'");
                        $b=mysqli_fetch_array($a);
                    ?>
                    <h5><center>User Name: <strong><?php echo ucwords($b['Name']); ?></strong></center></h5>
                    <form role="form" method="POST" action="delete_user.php<?php echo '?id='.$data['UserID']; ?>">
                </div>                 
                </div>
...
<!-- Edit Exeat User Details -->
<div class="modal fade" id="edit_<?php echo $data['UserID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                   <img src="img/img/download.jpg">&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="modal-title" id="myModalLabel" style="font-size: 20px;">  Edit Exeat Administrator details</span>
                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
...
$a=mysqli_query($conn,"SELECT * FROM user WHERE UserID='".$data['UserID']."'");
                    ...
                    <form role="form" method="POST" action="edit_user.php<?php echo '?UserID='.$data['UserID']; ?>">
