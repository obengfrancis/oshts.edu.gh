            ...
            <div class="modal-content">
                <div class="modal-header">
                   <img src="img/img/download.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="modal-title" id="myModalLabel" style="font-size: 20px;">  ADD ADMISSION ADMINITRATOR</span>
...
<form role="form" method="POST" action="adduser1.php" enctype="multipart/form-data">
<div class="container-fluid">
